...
$("#contact-form").submit(function (event) {
    ...
    emailjs.init("user_TTDmetQLyGCLzHTDgqxm"); // Replace with your actual User ID

    // Use EmailJS to send the form data
    emailjs.sendForm('service_zwxtc2m', 'template_contact', '#contact-form')
        .then(function (response) {
            // On success, reset the form and notify the user
            console.log('SUCCESS!', response.status, response.text);
            $("#contact-form")[0].reset(); // Reset the form using jQuery
